...
class SuratTugas extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $this->load->model('Superadmin/Transaksi/M_SuratTugas','SuratTugas');
        $this->load->model('Superadmin/Master/M_Master','Master');
	}

	public function index()
	{

		$this->load->view('Superadmin/Transaksi/SuratTugas/manage');
	}
    ...
    public function Page()
	{
        ...
        // $config['base_url'] = base_url().'Superadmin/Transaksi/SuratTugas/Page';
	...
	{   
		...
		$this->load->view('Superadmin/Transaksi/SuratTugas/ubah',$data);
	}
