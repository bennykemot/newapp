<script>
	...
	$(document).ready(function () {
		...
		$('#addBtn').on('click', function () {
			...
			$('#tb-pbj-detail-test').append(`<tr id="R${++rowIdx}">
				...
				<td class="row-index text-center">
					<input type="text" id="volume_pbj[]" name="volume_pbj[]" value="">
				</td>
				<td class="row-index text-center">
					<input type="text" id="satuan[]" name="satuan[]" value="">
				</td>
				<td class="row-index text-center">
					<input type="text" id="rupiah[]" name="rupiah[]" value="">
				</td>
				<td class="row-index text-center">
					<input type="text" id="jumlah[]" name="jumlah[]" value="">
				</td>
	...
	function save_data() {
		if (confirm('Apakah Anda Yakin Mau Menyimpan Data Ini ?')) {
			document.getElementById('tb-pbj-detail-test-form').submit();
		}
	}
</script>
