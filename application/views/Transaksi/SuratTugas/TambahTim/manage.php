                ...
                <form id="FormTim" name="FormTim">
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <input type="text" id="nost" name="nost" value="<?= $ubah[0]['nost'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="input-field col s12">
                            ...
                            <div class="input-field col s10 " >
                            <input type="date" id="tglst" name="tglst" value="<?= $ubah[0]['tglst'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="input-field col s12">
                            ...
                            <div class="input-field col s10 " >
                            <textarea class="materialize-textarea" id="uraianst" name="uraianst" value="<?= $ubah[0]['uraianst'] ?>" readonly><?= $ubah[0]['uraianst'] ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="input-field col s12">
                            ...
                            <div class="input-field col s10 " >
                            <input type="date" id="tglst_mulai" name="tglst_mulai" onclick="Min_datemulai()" value="<?= $ubah[0]['tglmulaist'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="input-field col s12">
                            ...
                            <div class="input-field col s10 " >
                            <input type="date" id="tglst_selesai" name="tglst_selesai" onclick="Min_dateselesai()" value="<?= $ubah[0]['tglselesaist'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="input-field col s12">
                            ...
                            <div class="input-field col s10 " >
                                ...
                                <input type="text"  id="kdakun" name="kdakun"  value="<?= $ubah[0]['kdakun'] ?>" hidden>
                                <input type="text"  id="kdsatker" name="kdsatker"  value="<?= $ubah[0]['kdsatker'] ?>" hidden>
                                <input type="text"  id="kdkabkota" name="kdkabkota"  value="<?= $ubah[0]['kdkabkota'] ?>" hidden>
                        ...
                        <div class="input-field col s12">
                            ...
                            <div class="input-field col s10 " >
                                <input type="text"  id="beban_anggaran" name="beban_anggaran"  value="<?= $ubah[0]['nama_unit'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="input-field col s12">
                            ...
                            <div class="input-field col s10 " >
                                <input type="text"  id="ttd" name="ttd"  value="<?= $ubah[0]['nama_ttd'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div id = "counting" >
                            <div class="multi-field-wrapper">
                                ...
                                <?php if($ubah[0]['tim']== "WithTim"){include(APPPATH . 'views/Transaksi/SuratTugas/Tim.php');}
                                else{?>
                                        ...
                                        <div class="input-field col s12">
                                                <div class="input-field col s2"><label>Realisasi</label></div>
                                                    <div class="input-field col s4 " >
                                                        <input readonly id="realisasilabel" name="realisasilabel" value="">
                                                        <input readonly id="realisasi" name="realisasi" hidden value="">
                                                    </div>
