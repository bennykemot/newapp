      ...
      <div class="card" id="head">
          <div class="card-content" >
              <div class="row">
                  ...
                  <div class="col s11">
                      <h6> Mapping APP Satker : <?php echo $Satker[0]->nmsatker ?></h6>
                  </div>
              </div>
          </div>
      </div>
                ...
                <div class="col s12">
                    ...
                    <table id="tb-mappingapp" class="display" style="width:100%;white-space: nowrap !important;overflow: hidden;">
                        ...
                        <?php foreach($mapp as $p){?>
                              ...
                              <td class="text-right blue-text"><?=rupiah($p->alokasi)?></td>

                              <?php if ( $p->kdakun != "521811"){ ?>
                                <td class="text-center">
                                <a href="<?= site_url('Superadmin/Anggaran/Mappingapp/Tambah/'.$p->kdindex) ?>" class="btn-floating"><i class="material-icons">chevron_right</i></a>
                              </td>
                                <?php } else{ 
                                  echo '<td></td>';
                              } ?>
