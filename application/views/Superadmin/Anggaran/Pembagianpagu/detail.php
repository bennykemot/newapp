        ...
        <div class="card" id="head">
            <div class="card-content" >
                <div class="row">
                    ...
                    <!-- <div class="col s2">
                        <a class="btn modal-trigger green" href="<?= site_url('Superadmin/Anggaran/Pembagianpagu/export/'.$kdsatker. '/'.$thang) ?>">Export</a>
                    </div> -->
                </div>
								<div class="row">
										<div class="col s1">
                    ...
                    <div class="col s11">
                        <!-- <div class="col s4">
												...
												<table class="mt-1" width="100%">
													...
													<tbody>
														<tr>
															<td colspan="3"><?php echo $Satker[0]->nmsatker ?></td>
														</tr>
														<tr>
                ...
                <div class="col s12">
                    ...
                    <table id="tb-pembagianpagu" class="display" style="width:100%;white-space: nowrap !important;overflow: hidden;">
                        ...
                        <?php foreach($pp as $p){?>
                              ...
                              <td class="text-right blue-text"><?=rupiah($p->realisasi)?></td>
